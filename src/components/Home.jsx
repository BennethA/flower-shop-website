function Home() {
  return (
    <div id="home" className="bg-image bg-cover bg-right relative h-lvh flex items-start justify-center flex-col bg-[url(https://raw.githubusercontent.com/BennethA/flower-shop-website/main/src/assets/homeBg.jpg)]">
