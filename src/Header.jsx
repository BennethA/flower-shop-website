...
function Header() {
  ...
  return (
    <header className="flex fixed top-0 bg-white z-10 right-0 left-0 justify-between items-center p-2 px-[5%]">
      <div className="bg-red-400 rounded-[5px] w-[35px] max-sm:flex hidden flex-col gap-1 p-2 hover:opacity-80 active:opacity-80 hover:cursor-pointer" onClick={dropDown}>
