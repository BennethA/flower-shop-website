  ...
  return (
    <div className="mt-3 mx-[5%]">
      <div className="py-8">
        ...
        <div className="w-1/2 max-sm:w-full max-sm:h-[250px] items-center justify-center flex relative border-2 overflow-hidden bg-right bg-[url(src/assets/secondImg.jpg)]">
          <div className="absolute bottom-[45%] text-center right-0 left-0 bg-white opacity-90 text-2xl font-semibold text-red-400">
            Best Flower Sellers
          </div>
        </div>
